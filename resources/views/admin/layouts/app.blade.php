...
<head>
    ...
    <!-- Bootstrap 3.3.6 -->
    <link rel="stylesheet" href="{{url('/admin-assets/bootstrap/css/bootstrap.rtl.min.css')}}">
    <!-- Font Awesome -->
    ...
    -->
    <link rel="stylesheet" href="{{url('/admin-assets/dist/css/skins/skin-yellow-light.min.css')}}">
...
|---------------------------------------------------------|
-->
<body class="hold-transition skin-yellow-light sidebar-mini" style="direction:rtl">
<div class="wrapper">
